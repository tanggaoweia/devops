    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-download"></i> android phone 自动 build</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            getPullRequest() {
                let api = "android_phone/manual_pull_info";
                axios.get(api, {}).then(res => {
            ...
            signPreview(index, row) {
                ...
                let api = 'android_phone/pull_request_info_of_month?build_id=' + buildId;
            ...
            search() {
                this.currentPage = 1;
                if (this.select_word !== '') {
                    let api = "/android_phone/table_info_where_pull_request_id_is_not_zero?page_num=1&select_word=" + this.select_word;
                    axios.get(api, {}).then(res => {
            ...
            getData(page_num) {
                let api = "/android_phone/table_info_where_pull_request_id_is_not_zero?page_num=" + page_num;
                if (this.select_word !== '') {
                    api = "/android_phone/table_info_where_pull_request_id_is_not_zero?page_num=" + page_num + "&select_word=" + this.select_word;
                }
                axios.get(api, {}).then(res => {
                    this.value = res.data.data;
                    this.total = res.data.total;
