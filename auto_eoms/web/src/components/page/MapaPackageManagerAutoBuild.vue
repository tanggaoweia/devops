    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-download"></i> mapa 自动 build</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="container">
            ...
            <div class="handle-box">
                ...
                <el-button type="primary" icon="el-icon-check" @click="getPullRequest">拉取最新信息</el-button>
            </div>
            <!---->
                ...
                <el-table-column type="expand">
                    <template slot-scope="scope">
                        ...
                        <el-table :data="scope.row.data">
                            ...
                            <el-table-column type="expand">
                                <template slot-scope="scope">
                                    <el-table :data="scope.row.data">
                                        ...
                                        <el-table-column label="是否上传测试报告" prop="is_report"
                            ...
                            <el-table-column label="build id" prop="build_id"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            queryReport(index, row) {
                ...
                let apk_id = row.id;
                let api = "/mapa/market_test_report?id=" + apk_id;
            ...
            handleChange(index, row) {
                ...
                let api = "mapa/update_test_result";
            ...
            signPreview(index, row) {
                ...
                let buildId = row.build_id;
                let api = 'mapa/pull_request_info_of_month?build_id=' + buildId;
            ...
            edit() {
                ...
                let api = 'mapa/update_description';
            ...
            search() {
                this.currentPage = 1;
                if (this.select_word !== '') {
                    let api = "/mapa/table_info_where_pull_request_id_is_not_zero?page_num=1&select_word=" + this.select_word;
                    axios.get(api, {}).then(res => {
            ...
            getData(page_num) {
                let api = "/mapa/table_info_where_pull_request_id_is_not_zero?page_num=" + page_num;
                if (this.select_word !== '') {
                    api = "/mapa/table_info_where_pull_request_id_is_not_zero?page_num=" + page_num + "&select_word=" + this.select_word;
                }
                axios.get(api, {}).then(res => {
                    this.value = res.data.data;
                    this.total = res.data.total;
