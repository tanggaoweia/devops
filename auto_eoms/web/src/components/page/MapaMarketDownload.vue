    ...
    <div class="download">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-download"></i> mapa市场部下载</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            edit() {
                ...
                let api = "/mapa/update_market_desc";
                ...
                axios.post(api, params).then((val) => {
                    ...
                    if (code === 1) {
                        let api = "mapa/market_table_info?page_num=" + this.currentPage;
                        this.getData(api);
            ...
            downloadTestReport(row){
                ...
                let api = axios.defaults.baseURL + "/mapa/download_test_report?id=" + report_id;
                window.open(api)
            },
            ...
            handlePreview(index, row) {
                ...
                let apk_id = row.id;
                let api = "/mapa/sign_pull_request_info?id=" + apk_id;
                axios.get(api, {}).then(res => {
            ...
            search() {
                let api = "mapa/market_table_info?page_num=" + this.currentPage + "&select_word=" + this.select_word
            ...
            empty() {
                ...
                this.startData = '';
                this.endData = '';
                let api = "mapa/market_table_info?page_num=1";
                this.getData(api)
            },
            ...
            handleCurrentChange(val) {
                ...
                let api = "mapa/market_table_info?page_num=" + val;
                if (this.select_word !== '' || this.startData !== '' || this.endData !== '') {
                    api = "mapa/market_table_info?page_num=" + val + "&select_word=" + this.select_word
                        + "&start_time=" + this.startData + "&end_time=" + this.endData;
                }
                this.getData(api)
            },
