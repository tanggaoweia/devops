    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-download"></i> mapa 手动 build</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            signPreview(index, row) {
                ...
                let api = 'mapa/pull_request_info_of_month?time=' + time;
            ...
            search() {
                this.currentPage = 1;
                if (this.select_word !== '') {
                    let api = "/mapa/table_info_where_pull_request_id_is_zero?page_num=1&select_word=" + this.select_word;
                    axios.get(api, {}).then(res => {
            ...
            getData(page_num) {
                let api = "/mapa/table_info_where_pull_request_id_is_zero?page_num=" + page_num;
                if (this.select_word !== '') {
                    api = "/mapa/table_info_where_pull_request_id_is_zero?page_num=" + page_num + "&select_word=" + this.select_word;
                }
                axios.get(api, {}).then(res => {
                    this.value = res.data.data;
                    this.total = res.data.total;
